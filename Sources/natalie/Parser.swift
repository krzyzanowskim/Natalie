...
struct Parser {
    ...
    func process(os: OS) -> String {
        ...
        if os == OS.iOS {
            ...
            output += "\n\n"
            output += "    func dequeueReusableCell<T: ReusableViewProtocol>(reusable: T, for: IndexPath) -> UICollectionViewCell? {\n"
            ...
            output += "\n\n"
            output += "    func dequeueReusableCell<T: ReusableViewProtocol>(reusable: T, for: IndexPath!) -> UITableViewCell? {\n"
            output += "        if let identifier = reusable.storyboardIdentifier {\n"
